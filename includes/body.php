<body>
  ...
  <div class="youtube">
    <div class="youtube-content"> <!-- Columna izquierda con video -->
      <div class="youtube-video"> <iframe width="100%" height="315" src="https://www.youtube.com/embed/1qsx5zpIp7w?start=14" title="YouTube video player" frameborder="0" allowfullscreen></iframe> <!-- Texto pequeño debajo del video -->
      ...
      <div class="youtube-right">
        ...
        <div class="youtube-info">
          <p>Sintoniza en vivo los sorteos de las 11:00 a.m. y 9:00 p.m. por canal 5.</p>
          <p>Podrás disfrutar del sorteo de las 9:00 p.m. por Nuestras redes sociales.</p>
        </div>
      </div>
    </div> <!-- Botón centrado debajo -->
